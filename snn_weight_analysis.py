...
networkFile = "./fpga_snn_models/networks/if_Poisson_64_32bit_snn.pt"
weightFileDirectory = "./fpga_snn_models/networks/if_Poisson_64_32bit_weights"

network = load("./fpga_snn_models/networks/if_Poisson_64_32bit_snn.pt")
