...
class IFNetwork16(Network):
    ...
    def __init__(
        ...
        :param norm: Input to excitatory layer connection weights normalization
            constant.
        :param theta_plus: On-spike increment of ``IFNodes`` membrane
            threshold potential.
        :param tc_theta_decay: Time constant of ``IFNodes`` threshold
            potential decay.
